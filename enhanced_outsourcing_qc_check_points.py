...
from enhanced_checkpoint_strategies import EnhancedCheckpointRegistry


class EnhancedOutsourcingQcCheckPoints:
    """Enhanced QC check points with comprehensive validation and detailed reporting."""

    def __init__(self, df: pd.DataFrame, use_enhanced: bool = True):
        """
        ...
        if use_enhanced:
            ...
            # Initialize legacy checkpoint registry
    ...
    def get_failures(self) -> Dict[str, List[Dict[str, Any]]]:
        ...
        if self.use_enhanced:
            ...
            return self._get_legacy_failures()
    ...
    def get_enhanced_results(self) -> Dict[str, Any]:
        ...
        if not self.use_enhanced:
            raise ValueError("Enhanced results only available when use_enhanced=True")
    ...
    def get_vendor_analysis(self) -> Dict[str, Any]:
        ...
        """
        if not self.use_enhanced:
            raise ValueError("Vendor analysis only available when use_enhanced=True")
    ...
    def _get_legacy_failures(self) -> Dict[str, List[Dict[str, Any]]]:
        """Get failures using legacy validation system."""
        failures = {}
    ...
    def add_checkpoint(self, checkpoint):
        """Add a new checkpoint to the appropriate registry."""
        if self.use_enhanced:
    ...
    def remove_checkpoint(self, checkpoint_name: str):
        """Remove a checkpoint by name from the appropriate registry."""
        if self.use_enhanced:
    ...
    def export_detailed_report(self, output_file: Optional[str] = None) -> Dict[str, Any]:
        ...
        """
        if not self.use_enhanced:
            raise ValueError("Detailed reports only available when use_enhanced=True")
        ...
        report = {
            ...
            "legacy_failures": self._get_legacy_failures() if hasattr(self, '_get_legacy_failures') else {}
        }
    ...
    def get_summary_statistics(self) -> Dict[str, Any]:
        ...
        if self.use_enhanced:
            ...
            failures = self._get_legacy_failures()
            total_tools = len(self.df)
            failed_tools = len(set(
                failure.get('Tool_Number')
                for checkpoint_failures in failures.values()
                for failure in checkpoint_failures
                if 'Tool_Number' in failure
            ))
